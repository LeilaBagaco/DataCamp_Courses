...
# 1 - Run GridSearchCV to find the best hyperparameters using the training set.

# 2 - Print the best values of the parameters.

# 3 - Print out the accuracy on the test set, which was not used during the cross-validation procedure.
