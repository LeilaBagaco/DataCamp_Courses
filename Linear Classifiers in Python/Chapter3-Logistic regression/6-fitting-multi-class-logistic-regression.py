...
# 1 - Fit a one-vs-rest logistic regression classifier and report the results.

# 2 - Fit a multinomial logistic regression classifier by setting the multi_class parameter, plus setting to be solver = "lbfgs", and report the results.
