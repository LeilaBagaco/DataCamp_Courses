...
# 4.1 - Inside GridSearchCV(), specify the classifier, parameter grid, and number of folds to use.
# 4.2 - Use the .fit() method on the GridSearchCV object to fit it to the data X and y.
