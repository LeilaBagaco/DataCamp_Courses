...
# 1.1 - Setup a k-NN classifier with the number of neighbors equal to k.
# 1.2 - Fit the classifier with k neighbors to the training data.
# 1.3 - Compute accuracy scores the training set and test set separately using the .score() method and assign the results to the train_accuracy and test_accuracy arrays respectively.
