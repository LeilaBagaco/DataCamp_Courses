...
# In this exercise, you will practice fitting ridge regression models over a range of different alphas, and plot cross-validated R^2 scores for each, using this function that we have defined for you, which plots the R^2 score as well as standard error for each alpha:
...
# 2.1 - Specify the alpha value for the regressor to use.
# 2.2 - Perform 10-fold cross-validation on the regressor with the specified alpha. The data is available in the arrays X and y.
# 2.3 - Append the average and the standard deviation of the computed cross-validated scores. NumPy has been pre-imported for you as np.
