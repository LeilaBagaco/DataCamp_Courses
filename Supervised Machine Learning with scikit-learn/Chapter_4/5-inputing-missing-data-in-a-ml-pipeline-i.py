# ********** Inputng missing data in a ML pipeline I **********
...
# 4.1 - The first tuple should consist of the imputation step, using imp.
# 4.2 - The second should consist of the classifier.
